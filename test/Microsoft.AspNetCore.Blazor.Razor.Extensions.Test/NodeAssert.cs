...
namespace Microsoft.AspNetCore.Blazor.Razor
{
    internal static class NodeAssert
    {
        ...
        public static HtmlContentIntermediateNode Content(IntermediateNode node, string content)
        {
            Assert.NotNull(node);
            ...
            Assert.Equal(content, actual.ToString());
            return contentNode;
        }

        public static HtmlContentIntermediateNode Content(IntermediateNodeCollection nodes, string content)
        {
            Assert.NotNull(nodes);
            return Content(Assert.Single(nodes), content);
        }
